...
return [
    ...
    'search' => [
        ...
        // Поріг косинусної відстані (0 = ідентичні, 2 = протилежні), вище
        // якого фрагмент вважається абсолютно нерелевантним і відкидається
        // ще до LLM (FR-009). Навмисно ліберальний за замовчуванням: короткі/
        // загальні фрагменти реальних embedding-моделей часто дають
